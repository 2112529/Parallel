...
int main()
{
    ...
    cout << "SSE_OMP:"<<(mtail - mhead) * 1000.0 / freq<<endl;
    ...
    SSE_OMP();
    QueryPerformanceCounter((LARGE_INTEGER*)&mtail);
    cout << "AVX_OMP:" << (mtail - mhead) * 1000.0 / freq << endl;;
    ...
    SSE_OMP_ALIGNED();
    QueryPerformanceCounter((LARGE_INTEGER*)&mtail);
    cout << "SSE_OMP_ALIGNED:" << (mtail - mhead) * 1000.0 / freq << endl;
