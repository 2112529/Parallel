...
int main()
{
    ...
    cout << "OMP_Neon: " << n << " Time: " << (tail.tv_sec - head.tv_sec) * 1000.0 + (tail.tv_usec - head.tv_usec) / 1000.0 << "ms";
    ...
    OMP_Neon_Align();
    gettimeofday(&tail, NULL);
    cout << "OMP_Neon_Align: " << n << " Time: " << (tail.tv_sec - head.tv_sec) * 1000.0 + (tail.tv_usec - head.tv_usec) / 1000.0 << "ms";
    // Print();
    ReSet();
    gettimeofday(&head, NULL);
    OMP_Neon_auto();
    gettimeofday(&tail, NULL);
    cout << "OMP_Neon_auto: " << n << " Time: " << (tail.tv_sec - head.tv_sec) * 1000.0 + (tail.tv_usec - head.tv_usec) / 1000.0 << "ms";
    return 0;
}